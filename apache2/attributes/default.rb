...
# Deploy settings
default[:apache][:production][:dir] = "/apps/production"
default[:apache][:production][:hostname] = "example.com"
default[:apache][:staging][:dir] = "/apps/staging"
default[:apache][:staging][:hostname] = "example.net"
